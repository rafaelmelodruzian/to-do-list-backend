...
-- Criar tabelas as tabelas necessarias 
CREATE TABLE
    usuarios (
...
INSERT INTO
    usuarios_tarefas (usuario_id, tarefa_id)
VALUES ('usu001', 'tar001'), ('usu002', 'tar002'), ('usu001', 'tar003'), ('usu002', 'tar003');
...
SELECT *
FROM tarefas
    LEFT JOIN usuarios_tarefas ON usuarios_tarefas.tarefa_id = tarefa_id
    LEFT JOIN usuarios ON usuarios_tarefas.usuario_id = usuario_id;